...
WEB_INTERFACE_STOP_TIMEOUT_SECONDS = 12
WEB_INTERFACE_STOP_FORCE_EXIT_TIMEOUT_SECONDS = 5
            ...
            if serve_finished is not None:
                try:
                    await self._wait_for_serve_finished(
                        serve_finished,
                        WEB_INTERFACE_STOP_TIMEOUT_SECONDS,
                    )
                    ...
                    await self._wait_for_serve_finished(
                        serve_finished,
                        WEB_INTERFACE_STOP_FORCE_EXIT_TIMEOUT_SECONDS,
                    )
